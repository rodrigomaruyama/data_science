...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, histogram}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, 'loop for density plots'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, 'removing outliers'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, 'Accuracy mean for RF model'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, 'Accuracy Mean Table RF'}
...
```{r echo = FALSE, eval = FALSE, warning = FALSE, message = FALSE, 'Plot one'}

# Winner Random Forest Predictor
model <- randomForest(quality ~ . - quality, data = train.pca)
rf.pred <- predict(model, newdata = test.pca[, -9])
rocr.df$predictions <- list(rf.pred)
rocr.df$labels <- test.pca[, 9]
pred <- prediction(rf.pred, test.pca$quality)
...
### Plot Two
```{r echo = TRUE, eval = FALSE, warning = FALSE, message = FALSE, 'Plot Two'}
