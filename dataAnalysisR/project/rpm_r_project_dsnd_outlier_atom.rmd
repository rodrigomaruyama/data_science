...
```{r echo = FALSE, warning = FALSE, message = FALSE, set working directory}
#setwd("C:/Users/maru/Documents/dsNanodegree/machine-learning-master/projects/finding_donors/dataAnalysisR/project/")
```


```{r echo = FALSE, warning = FALSE, message = FALSE, install packages}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, load dataset}
# Load the Data
...
```{r echo = FALSE, warning = FALSE, message = FALSE, dataset size}
dim(wdf)
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, summary dataset}
swdf <- summary(wdf)
...
```{r echo = FALSE, warning = FALSE, message = FALSE, remove outliers}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, loop for density plots}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, quality.2}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, pie chart}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, ggpairs}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, corrplot}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, bivariate boxplots}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, bivariate scatter plots}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, multivariate plots}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, reloading dataset for ML}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, Random Forest}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, SVM parameters}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, SVM}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, Rpart}
#rpart
...
```{r echo = FALSE, warning = FALSE, message = FALSE, PCA}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, New PCA dataset}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, Random Forest PCA}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, SVM parameters PCA}
...
```{r echo = FALSE, warning = FALSE, message = FALSE, SVM PCA}
# SVM
...
```{r echo = FALSE, warning = FALSE, message = FALSE, Rpart PCA}
#rpart
...
### Plot One
```{r echo = FALSE, warning = FALSE, message = FALSE, Plot one}
...
### Plot Two
```{r echo = FALSE, warning = FALSE, message = FALSE, Plot Two}
...
### Plot Three
```{r echo = FALSE, warning = FALSE, message = FALSE, Plot Three}
