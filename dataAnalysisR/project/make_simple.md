...
while (a < 10){
  ...
  write(str, file = 'data/accuracy_rf.csv', append = TRUE)
}
...
while (a < 10){
  ...
  write(str, file = 'data/accuracy_models_svm.csv', append = TRUE)
}
...
while (a < 10){
  ...
  write(str, file = 'data/accuracy_models_rpart.csv', append = TRUE)
}
...
<td style='padding-left: 1em; padding-right: 1em; text-align: center;'>62.17</td>
...
<td style='padding-left: 1em; padding-right: 1em; border-bottom: 2px solid grey; text-align: center;'>62.42</td>
...
<tr>
<td style='border-bottom: 2px solid grey; text-align: left;'>Outliers Data</td>
<td style='padding-left: 1em; padding-right: 1em; border-bottom: 2px solid grey; text-align: center;'>66.24</td>
</tr>
</tbody>
</table>

We could increase the accuracy in more than 3.5% with Random Forest and PCA.
...
```r
wdf.raw$quality <- as.numeric(wdf.raw$quality)
wdf.outliers$quality <- as.numeric(wdf.outliers$quality)

df.list <- list(data.frame(wdf.raw), data.frame(wdf.outliers))
a <- 0
for (df in df.list){
...
![plot of chunk Plot Three](figure/Plot Three-1.png)![plot of chunk Plot Three](figure/Plot Three-2.png)
...
![plot of chunk Plot Three](figure/Plot Three-3.png)
