...
```{r echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE, 'install packages'}
...
![univariate histogram without outliers](pictures/histogram_univariate_outliers.png)
...
rating = as.numeric(c(1565, 1055, 2139))
...
![Postive Correlation bivariate](pictures/4_11_bivariate_outliers.png)

![Negative Correlation bivariate](pictures/4_12_bivariate_outliers.png)

![Zero Correlation bivariate](pictures/4_13_bivariate_outliers.png)
