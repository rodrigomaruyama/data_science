...
```{r echo = FALSE, eval = TRUE, warning = FALSE, 'outliers_Q3_Q1'}


for (f in names(wdf)) {
  q1 <- quantile(wdf[, f], 0.25)
  q3 <- quantile(wdf[, f], 0.75)
  step <- 1.5*(q3 - q1)
  #print(q1)
  #print(q3)
  #print(step)
  print(dim(subset(wdf, (f <= (q1 - step)) | (f >= (q3 + step)))))
}

```

```{r echo = FALSE, eval = TRUE, warning = FALSE, 'remove outliers'}
