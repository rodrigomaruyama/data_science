...
```{r echo = FALSE, eval = TRUE, warning = FALSE, 'outliers IQR'}
...
|----|--------------------------------------------|-------------|
| 1  | density x residual.sugar                   |    0.85     |
| 2  | total.sulfur.dioxide x free.sulfur.dioxide |    0.62     |
| 3  | density x total.sulfur.dioxide             |    0.56     |
| 4  | quality x alcohol                          |    0.42     |

|    | Negative correlation                       | correlation |
|----|--------------------------------------------|-------------|
| 1  | density x alcohol                          |   -0.82     |
| 2  | total.sulfur.dioxide x alcohol             |   -0.56     |
| 3  | alcohol x residual.sugar                   |   -0.48     |
...
## Plot Two
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'Plot Two'}
