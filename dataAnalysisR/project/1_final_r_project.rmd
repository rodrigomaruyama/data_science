...
```{r echo = FALSE, eval = TRUE, warning = FALSE, 'lilbrary'}
library(ROCR)
library(ggfortify)
library(ggplot2)
library(knitr)
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'summary dataset'}
swdf <- summary(wdf)
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, histogram}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'remove outliers'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'loop for density plots'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, quality.2}
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'pie chart'}
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'bivariate boxplots'}
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'bivariate scatter plots'}
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'multivariate plots'}
...
grid_multivariate <- grid.arrange(p1, p2, p3, p4, ncol = 2, 
  top = textGrob("Multivariate Plots",gp=gpar(fontsize=15,font=3)))
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'Accuracy mean'}
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'Alternative print' }
# Print the results
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'Plot PCA'}
# Variance plot
plot(wdf.pca, type = "l")
...
```{r echo = TRUE, eval = TRUE, warning = FALSE, 'Accuracy mean for RF model'}
...
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'PCA components plot'}
...
## Plot Two
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'Plot Two'}
...
## Plot Three
```{r echo = TRUE, eval = FALSE, warning = FALSE, 'Plot Three'}
