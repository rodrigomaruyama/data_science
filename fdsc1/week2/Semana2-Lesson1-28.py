...
def daysBetweenDates(year1, month1, day1, year2, month2, day2):
    ...
    assert year1<=year2 and month1<=month2 and day1<=day2, "iT IS NOT A VALID DATE!"
    days = 0
    assert dateIsBefore(year1, month1, day1, year2, month2, day2), "IT IS NOT A VALID DATE!"
